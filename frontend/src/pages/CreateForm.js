...
// ===================================================================================
// 1. Reusable & Responsive Component for Editing a Single Question
// ===================================================================================
const QuestionEditor = ({ question, qIndex, onQuestionChange, onRemoveQuestion, onOptionChange, onAddOption, onRemoveOption }) => {
    ...
    return (
        ...
        <div className="bg-black/20 border border-white/10 rounded-xl p-4 sm:p-6 space-y-4">
            {/* This container will stack vertically on mobile and go horizontal on medium screens and up */}
            <div className="flex flex-col md:flex-row justify-between items-start gap-4">
                ...
                {/* On mobile, this will be full-width, but on md+, it will shrink */}
...
// ===================================================================================
// 2. The Main Responsive Create Form Page
// ===================================================================================
const CreateForm = () => {
    ...
    // --- All your handler functions (handleQuestionChange, handleSubmit, etc.) remain the same ---
    ...
    return (
        ...
        <div className="container mx-auto p-4 md:p-6 lg:p-8">
            ...
            {/* Use responsive padding for the form card */}
            <form onSubmit={handleSubmit} className="bg-black/20 backdrop-blur-xl border border-white/10 rounded-2xl p-4 sm:p-6 md:p-8 shadow-2xl space-y-8">
                ...
                {/* --- Action Buttons --- */}
                {/* This flex container stacks vertically on mobile and goes horizontal on medium screens+ */}
